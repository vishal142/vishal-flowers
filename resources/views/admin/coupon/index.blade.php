      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-info">
            ...
            <a class="btn btn-success btn-sm" href="/admin/coupon/add-coupon"> <i class="ace-icon fa glyphicon-plus white" title="Add Coupon"></i> Add New </a>
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				$i = '1';
					foreach($recordset as $row)
					{
						...
						$editLink = '/admin/coupon/edit-coupon/'.$row->id;
				?>
                ...
                <tr id="tr<?php echo $row->id;?>">
                  ...
                  <td><?php echo ucfirst($row->coupon_value);?></td>
...
function change_status(id){
	...
	{
		$.ajax({
			url : baseurl+'/admin/coupon/change-status',
			type : 'POST',
			data : {'coupon_id':id},
			//dataType : 'json',
...
function delete_user(id,editID){
	if(confirm("Are you sure to delete of this Coupon ?"))
	{
		$.ajax({
			url : baseurl+'/admin/coupon/delete-coupon',
			type : 'POST',
			data : 'id=' + id,
			//dataType : 'json',
			beforeSend : function(jqXHR, settings ){
