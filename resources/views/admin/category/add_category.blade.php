      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" id="frm_user" name="frm_user" method="post" action="/admin/category/add_category_data" enctype="multipart/form-data">
              <div class="box-body">
                @csrf
             ...
             <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="category_name" placeholder="Category Name" class="col-xs-10 col-sm-5 form-control" value="" onblur="chk_categoery(this.value)"/> 
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <textarea name="description" placeholder="Description" class="col-xs-10 col-sm-5 form-control"/></textarea>
